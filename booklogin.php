...
<h2>login here</h2>
<div class="login ">
<form action="dbbooklogin.php" method="post">
 <table>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <p align="center"><input type="submit" class="btn btn-success" value="login" name="login"></p><br><br>
      </td>
    </tr>
    <tr>
      <td>
        <a href="signup.php"><p><img src="image/newuser.png" height="50" width="50">&nbsp;NEW USER</p></a><br>
      </td>
    </tr>
    <tr>
      <td>
        <a href="terms.php"><p>TERMS & CONDITION</p></a>
      </td>
    </tr>
